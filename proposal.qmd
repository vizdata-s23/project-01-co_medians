...
# data we decided not to use
#write_rds(pride_aggregates, "data/pride_aggregates.RDS")
#write_rds(fortune_aggregates, "data/fortune_aggregates.RDS")
#write_rds(pride_sponsors, "data/pride_sponsors.RDS")
#write_rds(corp_by_politician, "data/corp_by_politician.RDS")

# read data we are using
static_list <-readRDS("data/static_list.RDS")
contribution_data_all_states <-readRDS("data/contribution_data_all_states.RDS")

# read data we are not using
pride_aggregates <-readRDS("data/pride_aggregates.RDS")
fortune_aggregates <-readRDS("data/fortune_aggregates.RDS")
pride_sponsors <-readRDS("data/pride_sponsors.RDS")

...
ggplot() +
  ...
  geom_line(plot3_data_abbott, mapping = aes(x = factor(year), y = avg_amount, group = Politician), color = "#899499", linetype = "dashed", size = 1.1) +
  ...
  scale_color_manual(values = c("#899499", "#AA4A44", "gray", "#BF8F8C")) +
  guides(color = "none") + 
  theme_minimal() +
  labs(

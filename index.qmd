...
Looking at the second plot, we can see that the distributions for all four company categories is right-skewed and roughly unimodal. In general, a large proportion of donations for all categories is between 0 and $100,000. For the category of HRC pledge and donates to pride, we can see that the distribution is very loosely clustered compared to those of the other categories, and there's a wide range of donation amounts. The category of neither (no HRC pledge and doesn't donate to pride) has the tightest distribution of all of the categories. This could be because more companies are donating small amounts towards anti-LGBTQ+ campaigns as opposed to a one-time large amount. However, we also have to keep in mind the number of companies that fall under each category, as that could change our interpretations, thus we included the number of companies as an annotation. 

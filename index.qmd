...
From the line plot, we can see that the average USD amount per contribution to Greg Abbot are larger than for other groups of politicians. It is significantly higher than the average USD contribution for both senators and representatives, and Greg also receives a definitively higher average contribution than politicians with positions other than senator/representative including those with specific leadership positions, with the exception of the final year of data (2022). This is quite interesting and inline with our hypotheses, since Greg Abbot is an extremely outspoken republican politician and is likely to attract a lot of

...
## Q1 Plot 1 Limitations and Future Study
...
-   Our investigation could be furthered by looking into the magnitude of donations to Pride vs to anti-LGBTQ+ campaigns  to see if these companies are contributing equally to both or if the financial contributions are skewed 

-   It would be interesing to look at company efforts to promote inclusivity and equality in the workplace other than an HRC pledge
...
-   Methodology: Density plot showing density of number of contributions
...
## Q1 Plot 2 Limitations and Future Study
...
## Q2 Plot 1 Limitations and Future Study
...
## Q2 Plot 2 Limitations and Future Study

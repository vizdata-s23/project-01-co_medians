...
-   12 out of the 20 top companies are not Pride sponsors
...
-   Our investigation could be furthered by looking into the magnitude of donations to Pride vs to anti-LGBTQ+ campaigns  to see if these companies are contributing equally to both or if the financial contributions are skewed 
    -   We think it would be interesing to take a look at other company efforts to promote inclusivity and equality in the workplace outside of an HRC pledge
...
-   Methodology: Density plot showing density of number of contributions (Contribution amount in USD on x-axis and density on y-axis)
    ...
    -  Colored by category of company- Four categories of companies: 1) HRC pledge and donates to Pride, 2) HRC pledge and doesn't donate to Pride, 3) No HRC pledge and donates to Pride, 4) Neither HRC pledge nor donation to Pride

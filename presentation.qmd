...
new_static_list %>%
  ...
  coord_flip() +
  labs(
    title = "Top 20 companies in donations \nto anti-LGBTQ+ campaigns",
    x = "Company",
...
-   We would love to explore the magnitude of difference in contributions to pro- vs. anti-LGBTQ+ campaigns of these hypocritical companies

-   We think it would be interesting to explore the effects of other inclusivity measures in the workplace aside from an HRC pledge
